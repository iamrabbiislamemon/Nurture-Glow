...
export async function seedDatabase() {
  ...
  await query(
    "INSERT INTO doctor_specialties (name) VALUES ('Gynecologist'), ('Pediatrician'), ('Nutritionist'), ('Psychologist'), ('MBBS (General Physician)') ON DUPLICATE KEY UPDATE name = VALUES(name)"
  );
  await query(
  ...
  // Doctor catalog entries are now auto-created from real doctor-role users.
  // No dummy seed doctors are inserted.
