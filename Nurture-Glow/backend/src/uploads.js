...
const vaccineProofUploadDir = path.join(uploadRoot, 'vaccine-proofs');
...
ensureDir(vaccineProofUploadDir);
...
const vaccineProofUpload = createUploader(vaccineProofUploadDir, DOCUMENT_MIME_TYPES);
