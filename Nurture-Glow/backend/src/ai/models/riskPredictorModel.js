...
const buildRecommendations = (riskLevel, locale) => {
  ...
  const bn = {
    low: [
      ...
      'ডাক্তারের পরামর্শ অনুযায়ী হালকা ব্যায়াম চালিয়ে যান'
    ],
    medium: [
      'প্রতিদিন রক্তচাপ ও উপসর্গ পর্যবেক্ষণ করুন',
      'সাম্প্রতিক পরিমাপ ডাক্তারের সাথে আলোচনা করুন',
      'বিশ্রাম ও পানি পানকে অগ্রাধিকার দিন'
    ],
    high: [
      'দ্রুত আপনার ডাক্তারের সাথে যোগাযোগ করুন',
      'মাথাব্যথা, দৃষ্টি পরিবর্তন, বা ফোলাভাব লক্ষ্য করুন',
      'চিকিৎসকের পরামর্শ না নেওয়া পর্যন্ত কঠিন কাজ এড়িয়ে চলুন'
    ]
  };
