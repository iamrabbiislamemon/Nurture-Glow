...
-- Vaccine Catalog (minimal defaults)
INSERT INTO vaccine_catalog (id, vaccine_name, description, recommended_week_start, recommended_week_end, is_required, is_active)
VALUES
('vac-tdap', 'Tdap', 'Tetanus, diphtheria, pertussis booster during pregnancy.', 27, 36, TRUE, TRUE),
('vac-flu', 'Influenza', 'Seasonal flu vaccine for pregnancy safety.', 1, 40, TRUE, TRUE),
('vac-hepb', 'Hepatitis B', 'Hepatitis B immunization (maternal)', 0, 8, TRUE, TRUE),
('vac-tt', 'Tetanus Booster', 'Tetanus booster for maternal protection', 20, 36, TRUE, TRUE),
('vac-bcg', 'BCG (Tuberculosis)', 'Birth-dose vaccine after delivery.', 41, 52, TRUE, TRUE),
('vac-opv0', 'Oral Polio Vaccine (OPV-0)', 'Oral polio vaccine at birth.', 41, 52, TRUE, TRUE),
('vac-hepb-birth', 'Hepatitis B (Birth Dose)', 'Hepatitis B birth dose for newborns.', 41, 52, TRUE, TRUE),
('vac-penta', 'Pentavalent (DPT-HepB-Hib)', 'Routine infant vaccine series.', 53, 104, TRUE, TRUE),
('vac-pcv', 'Pneumococcal (PCV)', 'Pneumococcal conjugate vaccine series.', 53, 104, TRUE, TRUE),
('vac-rota', 'Rotavirus', 'Rotavirus vaccine series.', 53, 104, TRUE, TRUE),
('vac-mr', 'Measles-Rubella (MR)', 'Measles and rubella vaccine.', 53, 104, TRUE, TRUE),
('vac-mmr', 'MMR Booster', 'Measles, mumps, rubella booster.', 60, 104, TRUE, TRUE)
ON DUPLICATE KEY UPDATE vaccine_name = VALUES(vaccine_name), description = VALUES(description), is_active = VALUES(is_active);

-- Vaccine Suggestions (week-based)
INSERT INTO vaccine_suggestions (id, week_start, week_end, vaccine_names, description, is_active)
VALUES
('vs-01-12', 1, 12, '["Influenza"]', 'Early pregnancy flu protection', TRUE),
('vs-13-26', 13, 26, '["Influenza"]', 'Second trimester flu protection', TRUE),
('vs-27-36', 27, 36, '["Tdap", "Influenza"]', 'Third trimester recommended vaccines', TRUE),
('vs-41-52', 41, 52, '["BCG (Tuberculosis)", "Oral Polio Vaccine (OPV-0)", "Hepatitis B (Birth Dose)"]', 'Birth-dose vaccines after delivery', TRUE),
('vs-53-104', 53, 104, '["Pentavalent (DPT-HepB-Hib)", "Pneumococcal (PCV)", "Rotavirus", "Measles-Rubella (MR)", "MMR Booster"]', 'Infant and early childhood schedule', TRUE)
ON DUPLICATE KEY UPDATE vaccine_names = VALUES(vaccine_names), description = VALUES(description), is_active = VALUES(is_active);
