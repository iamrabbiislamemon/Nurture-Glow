...
import { Mail, Lock, User, Loader2, ArrowRight, AlertCircle, Sparkles, CheckCircle, Phone, Users, Stethoscope, ShoppingBag, Shield, Eye, EyeOff, Check, X } from 'lucide-react';
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-3" role="form" aria-label="Registration form">
            ...
            <div className="space-y-1.5">
              ...
              <div 
                className="grid grid-cols-3 gap-3 p-3 rounded-lg border transition-all duration-300"
                style={{
