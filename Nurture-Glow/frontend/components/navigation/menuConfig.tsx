...
export function buildDoctorMenu(): MenuItem[] {
  return [
    ...
    { icon: <Syringe size={20} />, label: 'Vaccine Reviews', path: '/dashboard?tab=vaccines', tab: 'vaccines' },
    ...
    { icon: <Settings size={20} />, label: 'Settings', path: '/dashboard?tab=settings', tab: 'settings' },
  ];
}
...
function doctorSections(items: MenuItem[]): WorkspaceMenuSection[] {
  return [
    ...
    { title: 'Care', items: items.slice(4, 8), activeClass: 'bg-emerald-500/15 text-emerald-700 font-semibold', hoverClass: 'text-gray-600 hover:bg-emerald-50/50 hover:text-gray-900', accentClass: 'bg-emerald-500', activeIconClass: 'text-emerald-600' },
    { title: 'Operations', items: items.slice(8, 10), activeClass: 'bg-blue-500/15 text-blue-700 font-semibold', hoverClass: 'text-gray-600 hover:bg-blue-50/50 hover:text-gray-900', accentClass: 'bg-blue-500', activeIconClass: 'text-blue-600' },
    { title: 'Compliance', items: items.slice(10, 12), activeClass: 'bg-purple-500/15 text-purple-700 font-semibold', hoverClass: 'text-gray-600 hover:bg-purple-50/50 hover:text-gray-900', accentClass: 'bg-purple-500', activeIconClass: 'text-purple-600' },
    { title: 'Account', items: items.slice(12, 13), activeClass: 'bg-gray-500/15 text-gray-700 font-semibold', hoverClass: 'text-gray-600 hover:bg-gray-50 hover:text-gray-900', accentClass: 'bg-gray-500', activeIconClass: 'text-gray-600' },
  ];
}
...
export function buildQuickAccessItems(
  ...
  switch (role) {
    case 'doctor':
      return [doctorItems[0], doctorItems[4], doctorItems[5], doctorItems[6], doctorItems[2]];
    case 'pharmacist':
